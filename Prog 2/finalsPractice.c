...
void displayProdList(ProdList L)
{
    ...
    while(curr) {
        printf("\n%-7s", curr->prod.prodID);
        printf("%-12s", curr->prod.prodDesc.name);  
        printf("%-15d", curr->prod.prodDesc.weight);
	...
	//	printf("%-15d", );            // Complete this to display the weight of a choco record
